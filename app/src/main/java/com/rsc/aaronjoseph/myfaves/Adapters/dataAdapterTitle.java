...
public class dataAdapterTitle extends ArrayAdapter<MyFaves> {

    Context context;
    ArrayList<MyFaves> mfave;


    public dataAdapterTitle(Context context, ArrayList<MyFaves> myfaves){
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        viewHolder.Title.setText(data.get_title());
