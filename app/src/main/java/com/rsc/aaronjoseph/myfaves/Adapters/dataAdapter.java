...
public class dataAdapter extends ArrayAdapter<MyFaves> {

    Context context;
    ArrayList<MyFaves> mfave;


    public dataAdapter(Context context, ArrayList<MyFaves> myfaves){
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        viewHolder.Title.setText(data.get_category());
